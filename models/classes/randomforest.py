...
class randomforest():
	...
	# random forest model
	def rf_model(self):
		model = sken.RandomForestRegressor(min_samples_split = self.min_samples_split,  max_depth = self.max_depth, n_estimators = self.n_estimators, max_features = self.max_features)
